...
public void getTestData(){
    ...
    //ExcelUtil Classindan getDataList() methodunu excelden data alabilmek icin cagiralim
    ...
    for(Map<String,String> data : testData){
        ...
        //dataTablesExcel.startDate.sendKeys(data.get("Start date")); tabloda tarih formati düzeltilip kullanilabilir
